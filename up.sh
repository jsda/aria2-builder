...
OPENSSL=$(curl -sL https://openssl-library.org/source/ | grep -A2 '\[LTS\]' | grep -oE 'openssl-[0-9]+\.[0-9]+\.[0-9]+' | head -n1 | awk '{print "https://github.com/openssl/openssl/releases/download/" $1 "/" $1 ".tar.gz"}')
